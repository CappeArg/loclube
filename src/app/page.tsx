...
export default function Home() {
  ...
  useEffect(() => {
    // Only fetch members if the user is logged in
    if (session) {
  ...
  // If there is no session, show the public page
  if (!session) {
    return (
      <div className="bg-gray-50 text-gray-800 font-sans">
        ...
        <main className="text-center py-20 px-6">
          ...
          <a href="/login" className="bg-gray-800 text-white font-bold py-3 px-8 rounded-full hover:bg-gray-700 transition-colors">
            Únete ahora
          </a>
        </main>
  ...
  // If there is a session, show the authenticated view (member list)
  return (
